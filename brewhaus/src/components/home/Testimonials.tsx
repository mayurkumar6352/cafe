    ...
    <section className="py-24 px-6 bg-cream-100 dark:bg-espresso-950 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {reviews.map((review, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-espresso-900 rounded-2xl p-5 border border-espresso-900/10 dark:border-cream-100/10 flex flex-col"
            >
              <Stars count={review.rating} />
              <p className="font-body text-sm text-espresso-700 dark:text-cream-300 leading-relaxed mt-3 flex-1">
                "{review.text}"
              </p>
              <div className="flex items-center gap-3 mt-5 pt-4 border-t border-espresso-900/10 dark:border-cream-100/10">
        ...
        <motion.div
          ...
          className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-8 p-6 bg-white dark:bg-espresso-900 rounded-2xl border border-espresso-900/10 dark:border-cream-100/10 max-w-2xl mx-auto"
        >
          ...
          <div className="w-px h-12 bg-espresso-900/10 dark:bg-cream-100/10 hidden sm:block" />
          <div className="text-center">
