              ...
              <AnimatePresence>
                {orders.map((order, i) => (
                  <motion.div
                    ...
                    className="bg-white dark:bg-espresso-900 rounded-2xl border border-espresso-900/10 dark:border-cream-100/10 overflow-hidden"
                  >
                    {/* Header row */}
                    <button
                    ...
                    <AnimatePresence>
                      {expanded === order.id && (
                        ...
                        >
                          <div className="px-5 pb-5 border-t border-espresso-900/10 dark:border-cream-100/10 pt-5 space-y-5">
                            {/* Status tracker */}
