    ...
    <div className="min-h-screen pt-24 pb-20 flex items-center justify-center px-6">
      <div className="max-w-lg w-full">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/10 dark:border-cream-100/10 mb-5"
        >
        ...
        {order && !loading && (
          <motion.div
            ...
            className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/10 dark:border-cream-100/10 mb-6"
          >
            ...
            <div className="pt-3 border-t border-espresso-900/10 dark:border-cream-100/10 flex justify-between">
