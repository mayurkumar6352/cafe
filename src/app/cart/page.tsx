        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <AnimatePresence>
              {items.map((item) => (
                <motion.div
                  ...
                  className="flex gap-4 p-4 bg-white dark:bg-espresso-900 rounded-2xl border border-espresso-900/6 dark:border-cream-100/6"
                >
          ...
          <div className="lg:col-span-1">
            <motion.div
              ...
              className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/8 dark:border-cream-100/8 sticky top-24"
            >
              ...
              <hr className="border-espresso-900/8 dark:border-cream-100/8 mb-5" />
