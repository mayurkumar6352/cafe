      ...
      <div className="max-w-6xl mx-auto pt-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            {step === 'details' && (
              <motion.div
                ...
                className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/8 dark:border-cream-100/8"
              >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/8 dark:border-cream-100/8 sticky top-24">
              ...
              <hr className="border-espresso-900/8 dark:border-cream-100/8 mb-4" />
              ...
              <hr className="border-espresso-900/8 dark:border-cream-100/8 my-4" />
              ...
              {/* Trust signals */}
              <div className="mt-5 space-y-2 pt-4 border-t border-espresso-900/6 dark:border-cream-100/6">
                {[
