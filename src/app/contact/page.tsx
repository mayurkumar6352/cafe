        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <div>
              ...
              {locations.map((loc) => (
                <div key={loc.name} className="bg-white dark:bg-espresso-900 rounded-2xl p-6 mb-4 border border-espresso-900/6 dark:border-cream-100/6">
            ...
            <div className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/6 dark:border-cream-100/6">
