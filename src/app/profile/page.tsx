    ...
    <div className="min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-2xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          {/* Profile card */}
          <div className="bg-white dark:bg-espresso-900 rounded-2xl p-6 border border-espresso-900/8 dark:border-cream-100/8 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <Link href="/orders" className="bg-white dark:bg-espresso-900 rounded-2xl p-5 border border-espresso-900/8 dark:border-cream-100/8 flex items-center gap-4 hover:border-cream-400/40 transition-colors group">
