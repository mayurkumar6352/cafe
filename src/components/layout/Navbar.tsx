    ...
    <>
      <motion.nav
        className={cn(
          ...
          scrolled || !isHome
            ? 'bg-cream-50/90 dark:bg-espresso-950/90 backdrop-blur-xl border-b border-espresso-900/8 dark:border-cream-100/8 shadow-sm'
            : 'bg-transparent'
        )}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-18 py-4">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={toggleDark}
                className="p-2.5 rounded-full hover:bg-espresso-900/8 dark:hover:bg-cream-100/8 transition-colors"
                ...
                <AnimatePresence>
                  {count > 0 && (
                    <motion.span
                      ...
                      animate={{ scale: 1 }}
                      exit={{ scale: 0 }}
                      className="absolute -top-1 -right-1 w-4.5 h-4.5 min-w-[18px] min-h-[18px] bg-cream-500 text-espresso-900 text-[10px] font-bold rounded-full flex items-center justify-center"
                    >
                      {count}
                    </motion.span>
                  )}
              ...
              {/* Mobile menu toggle */}
              <button
                className="md:hidden p-2.5 rounded-full hover:bg-espresso-900/8 dark:hover:bg-cream-100/8 transition-colors"
